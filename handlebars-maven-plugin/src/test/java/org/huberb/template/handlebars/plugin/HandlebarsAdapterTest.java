 ...
 * @author berni3
 */
public class HandlebarsAdapterTest {

    @Rule
    public TemporaryFolder folder = new TemporaryFolder();

    public HandlebarsAdapterTest() {
    }
    ...
    @Test
    public void testMerge() throws IOException, HandlebarsAdapter.InterpolateException {
        HandlebarsAdapter instance = new HandlebarsAdapter();
    ...
    @Test
    public void testMerge_varyToken_dollarlbrace_rbrace() throws IOException, HandlebarsAdapter.InterpolateException {
        HandlebarsAdapter instance = new HandlebarsAdapter();
    ...
    @Test
    public void testMerge_varyToken_hash_lrbracket_rbracket() throws IOException, HandlebarsAdapter.InterpolateException {
        HandlebarsAdapter instance = new HandlebarsAdapter();
    ...
    @Test
    public void testMerge_varyToken_lt_gt() throws IOException, HandlebarsAdapter.InterpolateException {
        HandlebarsAdapter instance = new HandlebarsAdapter();
